...
// CardPanel is the Coss UI preferred name; CardContent is kept for legacy
...
export { Card, CardHeader, CardFooter, CardTitle, CardDescription, CardPanel, CardContent };
